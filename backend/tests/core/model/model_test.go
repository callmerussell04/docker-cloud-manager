...
func TestBuildStatusHelpers(t *testing.T) {
	...
	require.True(t, model.IsBuildTerminalStatus(model.BuildStatusFailedResourceExhausted))
	...
	require.True(t, model.IsBuildFailedStatus(model.BuildStatusFailedResourceExhausted))
