...
func (UnimplementedContainerAPIServer) GetContainerRuntimeTarget(context.Context, *ContainerRuntimeTargetRequest) (*ContainerRuntimeTarget, error) {
	return nil, status.Error(codes.Unimplemented, "method GetContainerRuntimeTarget not implemented")
}
...
func (UnimplementedImageAPIServer) StartBuildRecord(context.Context, *BuildActionRequest) (*StartBuildRecordResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StartBuildRecord not implemented")
}
func (UnimplementedImageAPIServer) CancelBuildRecord(context.Context, *BuildActionRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CancelBuildRecord not implemented")
}
...
func (UnimplementedStatsAPIServer) GetSystemMonitoring(context.Context, *Empty) (*SystemMonitoringResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSystemMonitoring not implemented")
}
...
func (UnimplementedReportAPIServer) GetReportsOverview(context.Context, *ReportRangeRequest) (*ReportsOverviewResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetReportsOverview not implemented")
}
func (UnimplementedReportAPIServer) ListUserUsageReport(context.Context, *ListUserUsageReportRequest) (*PaginatedUserUsageReportResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListUserUsageReport not implemented")
}
func (UnimplementedReportAPIServer) GetUserUsageTimeline(context.Context, *GetUserUsageTimelineRequest) (*UserUsageTimelineResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserUsageTimeline not implemented")
}
...
func (UnimplementedReportAPIServer) RefreshUsageSnapshots(context.Context, *Empty) (*RefreshUsageSnapshotsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RefreshUsageSnapshots not implemented")
}
...
func RegisterReportAPIServer(s grpc.ServiceRegistrar, srv ReportAPIServer) {
	// If the following call panics, it indicates UnimplementedReportAPIServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
